...
import { ArrowLeft, Upload, File, X, Check, AlertTriangle, Eye, EyeOff, Lock, Video, Trash2 } from "lucide-react"
...
export default function UploadPage() {
  ...
  const handleAdminAuth = () => {
    if (adminPassword === "4933") {
      ...
      toast({
        ...
        description: "You can now upload APK files.",
      })
    } else {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      // Save to storage with analytics tracking
      ...
      toast({
        ...
        description: `${formData.name} has been uploaded successfully with${videoFile ? " video preview" : "out video"}.`,
      })
      ...
      toast({
        title: "Upload Failed",
        description: "Failed to upload the app. Please try again.",
        variant: "destructive",
      })
    } finally {
    ...
    <div className="container max-w-2xl mx-auto px-4 py-6 pb-20">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold">Upload APK</h1>
            <p className="text-sm text-muted-foreground">Add new apps to UltraXas Store</p>
          </div>
        </div>
              ...
              <div className="space-y-4">
                ...
                {videoPreviewUrl && (
                  <div className="rounded-lg overflow-hidden border">
                    <video src={videoPreviewUrl} controls className="w-full h-auto max-h-[300px]" preload="metadata" />
                  </div>
                )}
              </div>
            )}
